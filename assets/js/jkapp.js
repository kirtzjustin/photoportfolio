...
require([
    ...
    reactiveUtils
        ...
        .then(() => {
            ...
            app.coordinateConversion.watch("mode", function (newValue, oldValue, propertyName, target) {
                if (newValue === "capture") {
            ...
            reactiveUtils.watch(
                ...
                (newValue, oldValue) => {
                    ...
                    app.pointSymbolButtonColorValue = hexToRgbA(app.pointSymbolButtonColor.value, app.pointSymbolButtonOpacity.value);

                    app.pointSymbolButtonStyleValue = app.pointSymbolButtonStyle.options[app.pointSymbolButtonStyle.selectedIndex].value;

                    app.pointSymbolButtonSizeValue = app.pointSymbolButtonSize.options[app.pointSymbolButtonSize.selectedIndex].value;

                    app.pointSymbolButtonOutlineColorValue = hexToRgbA(app.pointSymbolButtonOutlineColor.value, app.pointSymbolButtonOutlineColorOpacity.value);

                    app.pointSymbolButtonOutlineWidthValue = parseInt(app.pointSymbolButtonOutlineWidth.options[app.pointSymbolButtonOutlineWidth.selectedIndex].value);

                    app.polylineSymbolButtonColorValue = hexToRgbA(app.polylineSymbolButtonColor.value, app.polylineSymbolButtonOpacity.value);

                    app.polylineSymbolButtonStyleValue = app.polylineSymbolButtonStyle.options[app.polylineSymbolButtonStyle.selectedIndex].value;

                    app.polylineSymbolButtonWidthValue = parseInt(app.polylineSymbolButtonWidth.options[app.polylineSymbolButtonWidth.selectedIndex].value);

                    app.polygonSymbolButtonColorValue = hexToRgbA(app.polygonSymbolButtonColor.value, app.polygonSymbolButtonOpacity.value);

                    app.polygonSymbolButtonStyleValue = app.polygonSymbolButtonStyle.options[app.polygonSymbolButtonStyle.selectedIndex].value;

                    app.polygonSymbolButtonOutlineColorValue = hexToRgbA(app.polygonSymbolButtonOutlineColor.value, app.polygonSymbolButtonOutlineColorOpacity.value);

                    app.polygonSymbolButtonOutlineWidthValue = parseInt(app.polygonSymbolButtonOutlineWidth.options[app.polygonSymbolButtonOutlineWidth.selectedIndex].value);
    ...
    app.map.when(() => {
        const handleActionBarClick = ({ target }) => {
            try {
                ...
                if (app.activeWidget) {
                    document.querySelector(`[data-action-id=${app.activeWidget}]`).active = false;
                    document.querySelector(`[data-panel-id=${app.activeWidget}]`).hidden = true;
                }
        ...
        document.querySelectorAll("calcite-action-bar").forEach((element) => element.addEventListener("click", handleActionBarClick));
    ...
    function assignAppProperties() {
        app.bookmarksWidgetListItem = document.getElementById("bookmarksWidgetListItem");
        app.bookmarksWidget3dWarningText = document.getElementsByClassName("esri-bookmarks__loader-container");
        app.extentIndicator = document.getElementById("extentIndicator");

        app.measureWidgetButtons2D = document.getElementById("measureWidgetButtons2D");

        app.measureWidgetButtons3D = document.getElementById("measureWidgetButtons3D");
        ...
        app.pointSymbolButtonOpacity = document.getElementById("colorSelectPointAlpha");
        ...
        app.pointSymbolButtonOutlineColor = document.getElementById("outlineColorSelectPoint");

        app.pointSymbolButtonOutlineColorOpacity = document.getElementById("outlineColorSelectPointAlpha");

        app.pointSymbolButtonOutlineWidth = document.getElementById("outlineWidthSelectPoint");

        app.polylineSymbolButtonColor = document.getElementById("colorSelectPolyline");

        app.polylineSymbolButtonOpacity = document.getElementById("colorSelectPolylineAlpha");

        app.polylineSymbolButtonStyle = document.getElementById("polylineStyleSelect");

        app.polylineSymbolButtonWidth = document.getElementById("polylineWidthSelect");

        app.polygonSymbolButtonColor = document.getElementById("colorSelectPolygon");

        app.polygonSymbolButtonOpacity = document.getElementById("colorSelectPolygonAlpha");

        app.polygonSymbolButtonStyle = document.getElementById("polygonStyleSelect");

        app.polygonSymbolButtonOutlineColor = document.getElementById("outlineColorSelectPolygon");

        app.polygonSymbolButtonOutlineColorOpacity = document.getElementById("outlineColorSelectPolygonAlpha");

        app.polygonSymbolButtonOutlineWidth = document.getElementById("polygonOutlineWidthSelect");
        app.printWidgetDiv = document.getElementById("printWidgetDiv");

        app.chartDiv = document.getElementById("chartDiv");

        app.queryingIndicatorContainer = document.getElementById("queryingIndicatorContainer");

        app.queryMeasureContainerArea = document.getElementById("queryMeasureContainerArea");

        app.queryMeasureContainerRadius = document.getElementById("queryMeasureContainerRadius");

        app.queryTools = document.getElementById("queryTools");

        app.clearHighlightedFeatures = document.getElementById("clearHighlightedFeatures");

        app.zoomToExtentOfQueryPoly = document.getElementById("zoomToExtentOfQueryPoly");
    ...
    function redisplayOverviewMap() {
        ...
        if (app.smartPhonesPortrait.matches || app.smartPhonesLandscape.matches || app.ipadPro125Landscape.matches || app.ipadPro125Portrait.matches || app.ipadPro105Landscape.matches || app.ipadPro105Portrait.matches || app.ipad3497.matches || app.ipad12MiniAir.matches) {
    ...
    function create2DDistanceMeasureWidget() {
        ...
        distanceButton.removeEventListener("click", app.eventListener2DMeasureWidgetDistance);
        ...
        distanceButton.addEventListener("click", app.eventListener2DMeasureWidgetDistance);
    }

    function create2DAreaMeasureWidget() {
        let distanceButton = document.getElementById("drawPolygon");
        distanceButton.removeEventListener("click", app.eventListener2DMeasureWidgetArea);
        ...
        distanceButton.addEventListener("click", app.eventListener2DMeasureWidgetArea);
    }
    ...
    function setActiveWidget3D(type) {
        ...
        switch (type) {
            case "distance":
                ...
                setActiveButton_3dmeasurewidget(document.getElementById("distanceButton"));
    ...
    function create3DDistanceMeasureWidget() {
        ...
        distanceButton.removeEventListener("click", app.eventListener3DMeasureWidgetDistance);
        ...
        distanceButton.addEventListener("click", app.eventListener3DMeasureWidgetDistance);
    }

    function create3DAreaMeasureWidget() {
        let distanceButton = document.getElementById("areaButton");
        distanceButton.removeEventListener("click", app.eventListener3DMeasureWidgetArea);
        ...
        distanceButton.addEventListener("click", app.eventListener3DMeasureWidgetArea);
    }
    ...
    function dataURIToBlob(dataURI) {
        ...
        (binStr = atob(dataURI.split(",")[1])), (len = binStr.length), (arr = new Uint8Array(len)), (mimeString = dataURI.split(",")[0].split(":")[1].split(";")[0]);
        for (i = 0; i < len; i++) {
    ...
    function switchView() {
        ...
        if (is3D) {
            ...
            reactiveUtils
                ...
                .then(function () {
                    app.activeView.watch("extent", () => updateOverviewMapExtent(extentIndicator));
                    app.overviewMapView.watch("extent", () => updateOverviewMapExtent(extentIndicator));
                })
                .then(function () {
                    reactiveUtils.when(() => app.activeView.stationary, updateOverviewMap);
                });
            app.activeView.ui.add([
                {
                    component: app.searchWidgetNav,
